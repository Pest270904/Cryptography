...
// Cryptopp libraries
#include "cryptoppclang/osrng.h"
using CryptoPP::AutoSeededRandomPool;

#include "cryptoppclang/cryptlib.h"
using CryptoPP::Exception;

#include "cryptoppclang/hex.h"
using CryptoPP::HexDecoder;
using CryptoPP::HexEncoder;

#include "cryptoppclang/base64.h"
using CryptoPP::Base64Decoder;
using CryptoPP::Base64Encoder;

#include "cryptoppclang/filters.h"
using CryptoPP::StreamTransformationFilter;
using CryptoPP::StringSink;
using CryptoPP::StringSource;

#include "cryptoppclang/des.h"
using CryptoPP::DES;

#include "cryptoppclang/modes.h"
using CryptoPP::CBC_Mode;

#include "cryptoppclang/secblock.h"
...
int main(int argc, char *argv[])
{
	...
	string plain = "Buổi thực hành thứ nhất-Tuấn Phát-clang";
